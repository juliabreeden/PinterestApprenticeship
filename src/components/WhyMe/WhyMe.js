...
const WhyMe = () => {
    ...
    const reasons = [
        ...
        { title: 'Curiosity and Commitment to Continuous Learning and Growth', description: 'I will always be a forever student, in both tech and non-tech topics. I consider myself a learning junkie, and am always seeking out new information, adopting a growth mindset in every endeavor. My intrinsic desire to not only learn and grow, but to use that knowledge and growth in ways that benefits others, would make me a great apprentice. As a Pinterest Apprentice, I would come in ready to hit the ground running, learn from brilliant engineers, and make meaningful contributions to the environment, both technically and interpersonally.'},
